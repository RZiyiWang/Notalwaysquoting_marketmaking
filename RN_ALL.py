...
adversary_name = experiment_number+'RN_adversary_ALL'
adversary_policyname = adversary_name+'_saved_policy'

MM_name = experiment_number+'RN_MM_ALL'
MM_policyname = MM_name+'_saved_policy'

MM_2actions_name = experiment_number+'RN_2action_ALL'
MM_2actions_policyname = MM_2actions_name+'_saved_policy'

MM_4actions_name = experiment_number+'RN_4action_ALL'
...
adversary_env = AdversaryEnvironmentWithControllingAll(eta=0.0, zeta=0.0)
...
MM_env = MarketMakerEnvironmentAgainstStrategicAdversaryWithControllingAll(adversary_policy=adversary_saved_policy,eta=0.0, zeta=0.0)
...
Evaluate_env_fixadversary = Evaluate_MarketMakerEnvironmentAgainstFixedAdversary(eta=0.0, zeta=0.0)
...
logging.set_verbosity(logging.INFO)
tf.compat.v1.enable_v2_behavior()
notquote_env = AllowNotQuoteEnvironment_ControlAll(quote_policy=MM_saved_policy,adversary_policy=adversary_saved_policy,eta=0.0, zeta=0.0)
...
Evaluate_env_fixadversary = Evaluate_AllowNotQuoteEnvironment_Fix(quote_policy=MM_saved_policy,eta=0.0, zeta=0.0)
...
logging.set_verbosity(logging.INFO)
tf.compat.v1.enable_v2_behavior()
notquote_4actions_env=AllowNotQuoteEnvironment_ControlAll_4actions(quote_policy=MM_saved_policy,adversary_policy=adversary_saved_policy, eta=0.0, zeta=0.0)
...
Evaluate_env_fixadversary = Evaluate_AllowNotQuoteEnvironment_Fix_4actions(quote_policy=MM_saved_policy,eta=0.0, zeta=0.0)
