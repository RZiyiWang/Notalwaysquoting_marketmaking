...
adversary_name = experiment_number+'RA_zeta0.01_adversary_FIX'
adversary_policyname = adversary_name+'_saved_policy'

MM_name = experiment_number+'RA_zeta0.01_MM_FIX'
MM_policyname = MM_name+'_saved_policy'

MM_2actions_name = experiment_number+'RA_zeta0.01_2action_FIX'
MM_2actions_policyname = MM_2actions_name+'_saved_policy'

MM_4actions_name = experiment_number+'RA_zeta0.01_4action_FIX'
...
MM_env = MarketMakerEnvironmentAgainstFixedAdversary(eta=0.0, zeta=0.01)
...
logging.set_verbosity(logging.INFO)
tf.compat.v1.enable_v2_behavior()
notquote_env = AllowNotQuoteEnvironment_Fix(quote_policy=MM_saved_policy,eta=0.0, zeta=0.01)
...
logging.set_verbosity(logging.INFO)
tf.compat.v1.enable_v2_behavior()
notquote_4actions_env=AllowNotQuoteEnvironment_Fix_4actions(quote_policy=MM_saved_policy,eta=0.0, zeta=0.01)
