...
adversary_name = experiment_number+'RN_adversary_B'
adversary_policyname = adversary_name+'_saved_policy'

MM_name = experiment_number+'RN_MM_B'
MM_policyname = MM_name+'_saved_policy'

MM_2actions_name = experiment_number+'RN_2action_B'
MM_2actions_policyname = MM_2actions_name+'_saved_policy'

MM_4actions_name = experiment_number+'RN_4action_B'
...
adversary_env = AdversaryEnvironmentWithControllingDrift(eta=0.0, zeta=0.0)
...
MM_env = MarketMakerEnvironmentAgainstStrategicAdversaryWithControllingDrift(adversary_policy=adversary_saved_policy,eta=0.0, zeta=0.0)
...
logging.set_verbosity(logging.INFO)
tf.compat.v1.enable_v2_behavior()
notquote_env = AllowNotQuoteEnvironment_ControlDrfit(quote_policy=MM_saved_policy,adversary_policy=adversary_saved_policy,eta=0.0, zeta=0.0)
...
logging.set_verbosity(logging.INFO)
tf.compat.v1.enable_v2_behavior()
notquote_4actions_env=AllowNotQuoteEnvironment_ControlDrfit_4actions(quote_policy=MM_saved_policy,adversary_policy=adversary_saved_policy, eta=0.0, zeta=0.0)
