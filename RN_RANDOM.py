...
adversary_name = experiment_number+'RN_adversary_RANDOM'
adversary_policyname = adversary_name+'_saved_policy'

MM_name = experiment_number+'RN_MM_RANDOM'
MM_policyname = MM_name+'_saved_policy'

MM_2actions_name = experiment_number+'RN_2action_RANDOM'
MM_2actions_policyname = MM_2actions_name+'_saved_policy'

MM_4actions_name = experiment_number+'RN_4action_RANDOM'
...
MM_env = MarketMakerEnvironmentAgainstRandomAdversary(eta=0.0, zeta=0.0)
...
logging.set_verbosity(logging.INFO)
tf.compat.v1.enable_v2_behavior()
notquote_env = AllowNotQuoteEnvironment_Random(quote_policy=MM_saved_policy,eta=0.0, zeta=0.0)
...
logging.set_verbosity(logging.INFO)
tf.compat.v1.enable_v2_behavior()
notquote_4actions_env=AllowNotQuoteEnvironment_Random_4actions(quote_policy=MM_saved_policy,eta=0.0, zeta=0.0)
