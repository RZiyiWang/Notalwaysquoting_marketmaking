...
adversary_name = experiment_number+'RA_eta0.01_adversary_ALL'
adversary_policyname = adversary_name+'_saved_policy'

MM_name = experiment_number+'RA_eta0.01_MM_ALL'
MM_policyname = MM_name+'_saved_policy'

MM_2actions_name = experiment_number+'RA_eta0.01_2action_ALL'
MM_2actions_policyname = MM_2actions_name+'_saved_policy'

MM_4actions_name = experiment_number+'RA_eta0.01_4action_ALL'
...
critic_action_fc_layers=[64, 128] 
...
adversary_env = AdversaryEnvironmentWithControllingAll(eta=0.01, zeta=0.0)
...
adversary_results=evaluation(policy=adversary_saved_policy, name=adversary_name,env=adversary_env,calculate_ratio=False)
adversary_validate_results=validate_with_random_policy(name=adversary_name,env=adversary_env)
...
MM_env = MarketMakerEnvironmentAgainstStrategicAdversaryWithControllingAll(adversary_policy=adversary_saved_policy,eta=0.01, zeta=0.0)
...
Evaluate_env_fixadversary = Evaluate_MarketMakerEnvironmentAgainstFixedAdversary(eta=0.01, zeta=0.0)
...
#Define: Evaluate: 2actions_RandomAdversary
...
logging.set_verbosity(logging.INFO)
tf.compat.v1.enable_v2_behavior()
notquote_env = AllowNotQuoteEnvironment_ControlAll(quote_policy=MM_saved_policy,adversary_policy=adversary_saved_policy,eta=0.01, zeta=0.0)
...
Evaluate_env_fixadversary = Evaluate_AllowNotQuoteEnvironment_Fix(quote_policy=MM_saved_policy,eta=0.01, zeta=0.0)
...
logging.set_verbosity(logging.INFO)
tf.compat.v1.enable_v2_behavior()
notquote_4actions_env=AllowNotQuoteEnvironment_ControlAll_4actions(quote_policy=MM_saved_policy,adversary_policy=adversary_saved_policy, eta=0.01, zeta=0.0)
...
Evaluate_env_fixadversary = Evaluate_AllowNotQuoteEnvironment_Fix_4actions(quote_policy=MM_saved_policy,eta=0.01, zeta=0.0)
